...
return [
    ...
    */
    ...
    | as an entire page via `Route::livewire('/post/create', 'pages::create-post')`.
    ...
    */
    ...
    | You can configure the component type and whether to use the high-voltage
    | emoji as a prefix in the sfc or mfc component names.
    |
    */
    ...
    */
    ...
    | This path is customizable to match your project's directory structure.
    |
    */
    ...
    */
    ...
    | nested components more reliable by ensuring they all have keys.
    |
    */
    ...
    | If you want Bootstrap CSS, you can specify: "bootstrap".
    |
    */
    ...
    | a user's session to see if a new release has invalidated it. If there is
