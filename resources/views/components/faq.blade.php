<div class="container mx-auto">
    <div class="grid sm:grid-cols-2 mx-4 sm:space-y-0 space-y-12">
        ...
        <aside class="space-y-6 sm:!mt-3 sm:mx-0 mx-2">
            <div class="flex items-center pb-3 border-b border-b-black cursor-pointer">
            ...
            <div class="flex items-center pb-3 border-b border-b-black cursor-pointer">
                <div class="text-black font-bold">
                    Who curates the content on this platform?
                </div>
                <div class="grow text-right">
                    <x-heroicon-o-plus class="size-6 inline-block" />
                </div>
            ...
            <div class="flex items-center pb-3 border-b border-b-black cursor-pointer">
                <div class="text-black font-bold">
                    Can I request specific content or features?
                </div>
                <div class="grow text-right">
                    <x-heroicon-o-plus class="size-6 inline-block" />
                </div>
