<div class="container mx-auto">
    <div class="mx-4 bg-[#FFF1DB] rounded-badge sm:px-20 px-6 py-16 space-y-10">
        <div>
        ...
        <button class="btn bg-[#EF5A6F] font-bold text-white border-none hover:bg-[#EF5A6F] hover:brightness-90">
            Join now, it's free
