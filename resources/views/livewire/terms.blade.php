<div class="bg-gradient-to-b from-[#FFF1DB] space-y-20">
    ...
    <div class="container mx-auto">
        <div class="sm:max-w-3xl sm:mx-auto mx-4 space-y-8 text-stone-500">
            ...
            <h2 class="text-stone-700">Last Updated: Novemeber 30, 2024</h2>

            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Introduction </h2>
                <p>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Nature of the Service </h2>
                <p>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Content Attribution and Use </h2>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Takedown Requests </h2>
                <p>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Third-Party Content Disclaimer </h2>
                <p>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> User Interaction </h2>
                <ul class="list-disc list-inside">
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Children’s Use </h2>
                <p>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Monetization </h2>
                <ul class="list-disc list-inside">
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Global Access and Compliance </h2>
                <ul class="list-disc list-inside">
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Liability Disclaimer </h2>
                <ul class="list-disc list-inside">
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Intellectual Property </h2>
                <ul class="list-disc list-inside">
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Changes to the Terms </h2>
                <p>
            ...
            <div>
                <h2 class="text-stone-700 font-semibold text-lg mb-4"> Contact Us </h2>
                <p>
